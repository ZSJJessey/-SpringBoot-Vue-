  ...
  <div>
    <el-card>
      <el-row>
        ...
        <el-col :span="3">
          <el-button type="success" style="font-size: 18px;" icon="iconfont icon-r-paper" @click="submitClick">
            提交</el-button>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="3">
          <el-button type="success" style="font-size: 18px;" @click="openAdvice" size="mini" round>
      ...
      <el-row>
          ...
          <el-table :data="drugData" stripe border>
            ...
            <el-table-column label="操作" width="120" fixed="right">
              <template slot-scope="scope">
                <el-button type="success" style="font-size: 14px;" @click="addDrug(scope.row.drId)" size="mini" round>
        ...
        <el-col :span="12" class="drugRigth">
          <el-table stripe border :data="drugBuyData" class="rigthTable">
            ...
            <el-table-column label="操作" width="120" fixed="right">
              <template slot-scope="scope">
                <el-button type="danger" style="font-size: 14px;" icon="iconfont icon-r-delete" size="mini" round
      ...
      <el-row>
        <el-col :span="12">
          ...
          <el-table stripe border :data="checkData">
            ...
            <el-table-column label="操作" width="120" fixed="right">
              <template slot-scope="scope">
                <el-button type="success" style="font-size: 14px;" @click="addCheck(scope.row.chId)" size="mini" round>
                  <i class="iconfont icon-r-add" style="font-size: 16px;"></i>
                  增加</el-button>
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" width="120" fixed="right">
              <template slot-scope="scope">
                <el-button type="danger" style="font-size: 14px;" icon="iconfont icon-r-delete"
                  @click="deleteCheck(scope.row.chId)" size="mini" round> 移除</el-button>
              </template>
            </el-table-column>
          </el-table>
    ...
    <el-dialog title="诊断及医生建议编写" :visible.sync="adviceFormVisible">
      <el-input type="textarea" :rows="8" placeholder="请输入内容" v-model="advice">
      </el-input>
      <div slot="footer" class="dialog-footer">
        <el-button @click="adviceFormVisible = false" style="font-size: 18px;"><i class="iconfont icon-r-left"
