    ...
    <div class="login-index" :style="backgroundDiv">
        <div class="mid-index">
            <i style="
                    ...
                    left: 40px;
                    color:#4BA5FE;
                    position: absolute" class="iconfont icon-r-love ">
                登录医院管理系统
            </i>
            <el-form :model="loginForm" :rules="loginRules" ref="ruleForm" class="loginForm">
                ...
                <el-form-item class="btns">
                    ...
                    <el-button type="primary" size="small" @click="submitLoginForm('ruleForm')">

                        登录</el-button>

                    <el-button type="success" size="small" style="font-size: 18px" @click="registerFormVisible = true">
...
export default {
    ...
    data() {
        ...
        return {
            ...
            backgroundDiv: {
                backgroundImage:
                    "url(" + require("../assets/background3.jpg") + ")",
