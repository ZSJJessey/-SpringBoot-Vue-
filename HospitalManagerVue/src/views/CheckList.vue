            ...
            <el-table :data="checkData" stripe style="width: 100%" border>
                ...
                <el-table-column label="操作" width="250" fixed="right">
                    <template slot-scope="scope">
                        <el-button style="font-size: 18px" type="success" size="mini" round
                            @click="modifyDialog(scope.row.chId)">编辑</el-button>
                        <el-button style="font-size: 18px" type="danger" @click="deleteDialog(scope.row.chId)"
                            size="mini" round>
                            删除</el-button>
                    </template>
                </el-table-column>
