<template>
    <el-container>
        ...
        <el-header>
            <div class="words">
                <span @click="menuClick('doctorLayout')" style="font-size: 22px">
            ...
            <div class="words">
                ...
                <span><el-button type="danger" size="mini" @click="logout"><i class="iconfont icon-r-user3"
                            style="font-size: 15px;">&nbsp;退出&nbsp;</i></el-button></span>
            </div>
        </el-header>
        <el-container>
            <!-- 侧边栏 -->
            <el-aside width="200px">
                ...
                <el-menu background-color="#02203d" text-color="white" active-text-color="white"
                    ...
                    <el-menu-item index="doctorLayout" @click="menuClick('doctorLayout')" style="font-size: 20px">
                        <i class="iconfont icon-r-home" style="font-size: 26px">
                        </i>
                        首页
                    </el-menu-item>
                    <el-menu-item index="orderToday" @click="menuClick('orderToday')" style="font-size: 20px">
                        <i class="iconfont icon-r-edit" style="font-size: 26px">
                        </i>
                        今日挂号列表
                    </el-menu-item>
                    <el-menu-item index="doctorOrder" @click="menuClick('doctorOrder')" style="font-size: 20px">
                        <i class="iconfont icon-r-list" style="font-size: 26px">
                        </i>
                        历史挂号列表
                    </el-menu-item>
                    <el-menu-item index="inBed" @click="menuClick('inBed')" style="font-size: 20px">
                        <i class="iconfont icon-r-building" style="font-size: 26px">
                        </i>
                        住院申请管理
                    </el-menu-item>
                    <el-menu-item index="doctorCard" @click="menuClick('doctorCard')" style="font-size: 20px">
