...
public class Orders {
    ...
    public Orders(int oId, int pId, int dId, String oRecord, String oStart, String oEnd, Integer oState, String oDrug, String oCheck, Double oTotalPrice, Integer oPriceState, Integer countGender, String oAdvice, Doctor doctor, Patient patient, Integer countSection, String dName, String pName, String dSection) {
        this.oId = oId;
        this.pId = pId;
        this.dId = dId;
