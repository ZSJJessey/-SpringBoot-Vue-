...
public class Doctor implements Serializable {
    ...
    @JsonProperty("d_avatarUrl")
    private String dAvatarUrl;
    @JsonProperty("dPhone")
    @Excel(name = "手机号")
    ...
    public Doctor(Integer dId, String dPassword, String dName, String dGender, String dCard, String dEmail, String dAvatarUrl, String dPhone, String dPost, String dIntroduction, String dSection, Integer dState, Double dPrice, Integer dPeople, Double dStar, Double dAvgStar, String arrangeId) {
        this.dId = dId;
    ...
    public void setdAvatarUrl(String dAvatarUrl) {
        this.dAvatarUrl = dAvatarUrl;
    }
